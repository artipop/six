...
///
/// `ConfigurationStore` itself knows only keys and strings; every typed accessor lives beside the type it
/// decodes, which is the rule AGENTS.md states and the reason that file stopped dragging six
