...
extension StripWindow {
    ...
    func drawPermissionBar(_ hdc: HDC, _ question: StripModel.PermissionQuestion, in card: RECT) {
    ...
    func handlePermissionClick(_ column: StripModel.Column, card: RECT, x: Int, y: Int) -> Bool {
